...
// plugins/folder-page/src/components/PageList.tsx
...
function DateDisplay({ date }) {
  ...
  return /* @__PURE__ */ jsx("time", { dateTime: date.toISOString(), children: `${date.getFullYear()}-${pad(date.getMonth() + 1)}-${pad(date.getDate())}` });
}
var PageList = ({
  cfg,
  fileData,
...
// plugins/folder-page/src/i18n/locales/en-US.ts
var en_US_default = {
  pages: {
    folderContent: {
      folder: "Folder",
...
// plugins/folder-page/src/i18n/locales/ar-SA.ts
var ar_SA_default = {
  pages: {
    folderContent: {
      folder: "\u0645\u062C\u0644\u062F",
...
// plugins/folder-page/src/i18n/locales/ca-ES.ts
var ca_ES_default = {
  pages: {
    folderContent: {
      folder: "Carpeta",
...
// plugins/folder-page/src/i18n/locales/cs-CZ.ts
var cs_CZ_default = {
  pages: {
    folderContent: {
      folder: "Slo\u017Eka",
...
// plugins/folder-page/src/i18n/locales/de-DE.ts
var de_DE_default = {
  pages: {
    folderContent: {
      folder: "Ordner",
...
// plugins/folder-page/src/i18n/locales/en-GB.ts
var en_GB_default = {
  pages: {
    folderContent: {
      folder: "Folder",
...
// plugins/folder-page/src/i18n/locales/es-ES.ts
var es_ES_default = {
  pages: {
    folderContent: {
      folder: "Carpeta",
...
// plugins/folder-page/src/i18n/locales/fa-IR.ts
var fa_IR_default = {
  pages: {
    folderContent: {
      folder: "\u067E\u0648\u0634\u0647",
...
// plugins/folder-page/src/i18n/locales/fi-FI.ts
var fi_FI_default = {
  pages: {
    folderContent: {
      folder: "Kansio",
...
// plugins/folder-page/src/i18n/locales/fr-FR.ts
var fr_FR_default = {
  pages: {
    folderContent: {
      folder: "Dossier",
...
// plugins/folder-page/src/i18n/locales/he-IL.ts
var he_IL_default = {
  pages: {
    folderContent: {
      folder: "\u05EA\u05D9\u05E7\u05D9\u05D9\u05D4",
...
// plugins/folder-page/src/i18n/locales/hu-HU.ts
var hu_HU_default = {
  pages: {
    folderContent: {
      folder: "Mappa",
...
// plugins/folder-page/src/i18n/locales/id-ID.ts
var id_ID_default = {
  pages: {
    folderContent: {
      folder: "Folder",
...
// plugins/folder-page/src/i18n/locales/it-IT.ts
var it_IT_default = {
  pages: {
    folderContent: {
      folder: "Cartella",
...
// plugins/folder-page/src/i18n/locales/ja-JP.ts
var ja_JP_default = {
  pages: {
    folderContent: {
      folder: "\u30D5\u30A9\u30EB\u30C0",
...
// plugins/folder-page/src/i18n/locales/kk-KZ.ts
var kk_KZ_default = {
  pages: {
    folderContent: {
      folder: "\u049A\u0430\u043B\u0442\u0430",
...
// plugins/folder-page/src/i18n/locales/ko-KR.ts
var ko_KR_default = {
  pages: {
    folderContent: {
      folder: "\uD3F4\uB354",
...
// plugins/folder-page/src/i18n/locales/lt-LT.ts
var lt_LT_default = {
  pages: {
    folderContent: {
      folder: "Aplankas",
...
// plugins/folder-page/src/i18n/locales/nb-NO.ts
var nb_NO_default = {
  pages: {
    folderContent: {
      folder: "Mappe",
...
// plugins/folder-page/src/i18n/locales/nl-NL.ts
var nl_NL_default = {
  pages: {
    folderContent: {
      folder: "Map",
...
// plugins/folder-page/src/i18n/locales/pl-PL.ts
var pl_PL_default = {
  pages: {
    folderContent: {
      folder: "Folder",
...
// plugins/folder-page/src/i18n/locales/pt-BR.ts
var pt_BR_default = {
  pages: {
    folderContent: {
      folder: "Arquivo",
...
// plugins/folder-page/src/i18n/locales/ro-RO.ts
var ro_RO_default = {
  pages: {
    folderContent: {
      folder: "Dosar",
...
// plugins/folder-page/src/i18n/locales/ru-RU.ts
var ru_RU_default = {
  pages: {
    folderContent: {
      folder: "\u041F\u0430\u043F\u043A\u0430",
...
// plugins/folder-page/src/i18n/locales/th-TH.ts
var th_TH_default = {
  pages: {
    folderContent: {
      folder: "\u0E42\u0E1F\u0E25\u0E40\u0E14\u0E2D\u0E23\u0E4C",
...
// plugins/folder-page/src/i18n/locales/tr-TR.ts
var tr_TR_default = {
  pages: {
    folderContent: {
      folder: "Klas\xF6r",
...
// plugins/folder-page/src/i18n/locales/uk-UA.ts
var uk_UA_default = {
  pages: {
    folderContent: {
      folder: "\u0422\u0435\u043A\u0430",
...
// plugins/folder-page/src/i18n/locales/vi-VN.ts
var vi_VN_default = {
  pages: {
    folderContent: {
      folder: "Th\u01B0 m\u1EE5c",
...
// plugins/folder-page/src/i18n/locales/zh-CN.ts
var zh_CN_default = {
  pages: {
    folderContent: {
      folder: "\u6587\u4EF6\u5939",
...
// plugins/folder-page/src/i18n/locales/zh-TW.ts
var zh_TW_default = {
  pages: {
    folderContent: {
      folder: "\u8CC7\u6599\u593E",
...
// plugins/folder-page/src/i18n/index.ts
var locales = {
  "en-US": en_US_default,
  "ar-SA": ar_SA_default,
  "ca-ES": ca_ES_default,
...
// plugins/folder-page/src/components/styles/listPage.scss
var listPage_default = "ul.section-ul {\n  list-style: none;\n  margin-top: 2em;\n  padding-left: 0;\n}\n\nli.section-li {\n  margin-bottom: 1em;\n\n  & > .section {\n    display: grid;\n    grid-template-columns: fit-content(8em) 3fr 1fr;\n\n    @media all and (max-width: 600px) {\n      & > .tags {\n        display: none;\n      }\n    }\n\n    & > .desc > h3 > a {\n      background-color: transparent;\n    }\n\n    & .meta {\n      margin: 0 1em 0 0;\n      opacity: 0.6;\n    }\n  }\n}\n\n.popover .section {\n  grid-template-columns: fit-content(8em) 1fr !important;\n\n  & > .tags {\n    display: none;\n  }\n}\n";

// plugins/folder-page/src/components/FolderContent.tsx
  ...
  const FolderContent = (props) => {
    ...
    return /* @__PURE__ */ jsxs3("div", { class: "popover-hint", children: [
      ...
      /* @__PURE__ */ jsxs3("div", { class: "page-listing", children: [
        options.showFolderCount && /* @__PURE__ */ jsx3("p", { children: i18n(
          cfg?.locale ?? "en-US"
...
// plugins/folder-page/src/pageType.ts
